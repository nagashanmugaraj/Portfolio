...
function Admin() {
    ...
    const handleSave = async () => {
        setSaving(true)
        try {
            // Save ALL data (including projects) locally first
            await saveData(formData)

            // Then try to sync individual projects to Firestore collection
                            ...
                            <div className={styles.grid}>
                                ...
                                <div className={styles.field}>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => updateNestedField('contact', 'twitter', e.target.value)}
                                        className={styles.input}
                                ...
                                <div className={styles.field}>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => updateNestedField('contact', 'discord', e.target.value)}
                                        className={styles.input}
                                                    ...
                                                    <div className={styles.grid}>
                                                        <div className={styles.field}>
                                                            ...
                                                            <input
                                                                ...
                                                                className={styles.input}
                                                                placeholder="/img/projects/myproject.jpg or https://..."
                                                            />
                                                            {project.thumbnail && (
                                    ...
                                    <div key={item.id} className={styles.internshipItem}>
                                        ...
                                        <div className={styles.field}>
                                            ...
                                            <input
                                                type="text"
                                                value={item.image || ''}
                                                onChange={(e) => updateInternship(item.id, 'image', e.target.value)}
                                                className={styles.input}
                                                placeholder="/img/internships/company.jpg or https://..."
                                            />
                                            {item.image && (
                                                <img src={item.image} alt="Preview" className={styles.imagePreview} />
                                            )}
                                        </div>
                                    </div>
                                ))}
