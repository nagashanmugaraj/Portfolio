...
function Contact() {
    ...
    const socialLinks = [
        ...
        { icon: <FiInstagram />, href: data.contact?.instagram, label: 'Instagram' },
        { icon: <FiTwitter />, href: data.contact?.twitter, label: 'Twitter' },
        { icon: <FaDiscord />, href: data.contact?.discord, label: 'Discord' },
    ]
